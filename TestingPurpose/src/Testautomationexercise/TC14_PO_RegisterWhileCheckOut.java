...
public class TC14_PO_RegisterWhileCheckOut {
	public static void main(String[] args) throws Exception {
		...
		if (driver.getCurrentUrl().equals("https://automationexercise.com/view_cart")) {
			System.out.println("Navigated to view cart");
		} else {
			System.out.println("Not navigated ti VC");
		}
		...
		driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("younusbaj@gmail.com"+Keys.TAB+Keys.ENTER);
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("//a[@class='btn btn-default check_out']")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//textarea[@class='form-control']")).sendKeys("ThankYou");
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("//a[text()='Continue']")).click();
		System.out.println("TC is 14 is completed");
		driver.close();
	}
}
